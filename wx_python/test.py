...
class MyFrame1(wx.Frame):
	...
	def __init__(self, parent):
		...
		self.animation_ctrl = wx.adv.AnimationCtrl(self.m_panel8, wx.ID_ANY, anim=wx.adv.NullAnimation, size=(25, 25), pos=wx.DefaultPosition)
		self.bSizer20.Add(self.animation_ctrl, 0, wx.ALL | wx.ALIGN_CENTER_HORIZONTAL | wx.ALIGN_CENTER_VERTICAL, 5)
