...
class MyFrame1(wx.Frame):
	...
	def __init__(self, parent):
		...
		self.cached_tree = TreeCache(client=self._zk_client, path="/")
		self.cached_tree.start()
		def listen_changed(evt):
			print(evt)
		self.cached_tree.listen(listen_changed)
